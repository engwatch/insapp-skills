-- ============================================================
-- SQL-запросы для партнёрского отчёта МФО (ЛОКО-Банк)
-- БД: InsappCoreProd (MSSQL)
-- ============================================================

-- Параметры (заменить перед выполнением):
--   {pid}   = '4e96325d-0734-4989-bddd-eebf459d132e'  (PartnerId ЛОКО-Банк)
...
-- Доход партнёра = kv * 80 / 100 (с 01.04.2026; до этого — 100%)
...
--
-- СПЛИТ ЛОКО-Банк:
--   до 01.04.2026: ComissionRate = 100 (100% партнёру)
--   с 01.04.2026:  ComissionRate = 80  (80% партнёру, 20% Insapp)
--
-- ФОРМУЛЫ (фронтенд):
